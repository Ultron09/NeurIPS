# 🔬 NeurIPS Benchmark Specification: Split CIFAR-100 Evaluation Protocol

## 📌 Executive Summary
Protocol specifications for 10x10 disjoint sequential tasks under zero-replay constraints.
